...
contract SilverTradeEngine is ReentrancyGuard {
    ...
    function TransferERC20Ownership(address to, uint256 amountToTransfer) external checkNullAddress(to) {
        ...
        bool success = i_silverERC20.transfer(to, amountToTransfer);
        if (!success) {
